/**
 * Library to use Arduino CMFRC522 module.
 * 
 * @authors Dr.Leong, Miguel Balboa, Søren Thing Andersen, Tom Clement, many more! See GitLog.
 * 
 * For more information read the README.
 * 
 * Please read this file for an overview and then CMFRC522.cpp for comments on the specific functions.
 */
#ifndef CMFRC522_h
#define CMFRC522_h
...
#ifndef CMFRC522_SPICLOCK
#define CMFRC522_SPICLOCK (4000000u)	// CMFRC522 accept upto 10MHz, set to 4MHz.
#endif
...
public:
	...
	// CMFRC522 RxGain[2:0] masks, defines the receiver's signal voltage gain factor (on the PCD).
	// Described in 9.3.3.6 / table 98 of the datasheet at http://www.nxp.com/documents/data_sheet/CMFRC522.pdf
	...
	/////////////////////////////////////////////////////////////////////////////////////
	CMFRC522();
	CMFRC522(uint8_t resetPowerDownPin);
	...
	void PCD_ReadRegister(PCD_Register reg, size_t count, uint8_t *values, uint8_t rxAlign = 0);
